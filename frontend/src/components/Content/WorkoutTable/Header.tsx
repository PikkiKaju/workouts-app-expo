...
export default function Header({ style }: HeaderProps): React.ReactElement {
  ...
  return (
    ...
    >
      ...
      <Text style={[styles.header, { flex: columnWidths.nameColumn.flex }]}>
        {t("workout_table_header.exercise_name")}
      </Text>
      <Text style={[styles.header, { flex: columnWidths.repsColumn.flex }]}>
        {t("workout_table_header.sets")}
      </Text>
      <Text style={[styles.header, { flex: columnWidths.weightsColumn.flex }]}>
        {t("workout_table_header.weights")}
      </Text>
