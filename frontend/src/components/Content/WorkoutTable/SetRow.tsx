    ...
    <View style={[styles.setRow, props.style]}>
      {props.linker && (
        <View style={[styles.linker, props.linkerStyle]}>
          <View
            style={[
              styles.linkerVerticalLine,
              { backgroundColor: Colors.global.tableLines },
            ]}
          ></View>
          <View
            style={[
              styles.linkerHorizontalLine,
              { backgroundColor: Colors.global.tableLines },
            ]}
          ></View>
          {!props.last && (
      ...
      {props.weight !== undefined && (
        <Text style={props.textStyle}>{props.weight}</Text>
      )}
      {props.reps !== undefined && (
        <Text style={props.textStyle}>{props.reps}</Text>
      )}
      {props.remove && (
